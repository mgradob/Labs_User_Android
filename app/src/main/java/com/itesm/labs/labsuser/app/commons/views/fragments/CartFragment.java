...
import com.itesm.labs.labsuser.app.rest.clients.CartService;
...
public class CartFragment extends LabsBaseFragment {
    ...
    public void refreshList() {
        mCartService.getCartItemsOf(mSharedPreferences.getString(AppConstants.PREFERENCES_KEY_USER_TOKEN, ""),
    ...
    private void deleteUserCart() {
        mCartService.deleteCart(mSharedPreferences.getString(AppConstants.PREFERENCES_KEY_USER_TOKEN, ""),
                mAppGlobals.getLabLink(),
                mAppGlobals.getUser().getUserId())
                .subscribeOn(Schedulers.newThread())
                .observeOn(AndroidSchedulers.mainThread())
    ...
    private void postNewCart() {
        mCartService.postNewCart(mSharedPreferences.getString(AppConstants.PREFERENCES_KEY_USER_TOKEN, ""),
                mAppGlobals.getLabLink(),
