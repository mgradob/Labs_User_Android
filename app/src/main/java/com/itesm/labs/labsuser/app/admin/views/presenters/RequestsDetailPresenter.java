...
public class RequestsDetailPresenter extends BaseFragmentPresenter {
    ...
    private RequestDetailActivity mView;
    private String mUserId;

    private User mValidateUser;
    private ArrayList<ItemUserCartDetail> mUserCartDetails = new ArrayList<>();

    public RequestsDetailPresenter(RequestDetailActivity view, String userId) {
        super();
        this.mView = view;
        this.mUserId = userId;
    }
    ...
    public void getRequestDetail() {
        ...
        mSubscription = Observable.zip(
                mCartClient.getCartItemsOf(mLabsPreferences.getToken(), mLabsPreferences.getCurrentLab().getLink(), mUserId),
                mUserClient.getUser(mLabsPreferences.getToken(), mUserId),
