...
import com.itesm.labs.labsuser.app.rest.clients.RecordService;
...
public class RecordFragment extends LabsBaseFragment {
    ...
    public void refreshList() {
        mRecordService.getRecordOf(mSharedPreferences.getString(AppConstants.PREFERENCES_KEY_USER_TOKEN, ""),
